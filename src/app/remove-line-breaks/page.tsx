...
import { ClipboardCopy, ClipboardCheck, Scissors } from 'lucide-react';
...
export default function RemoveLineBreaksPage() {
  ...
  const handleRemoveLineBreaks = () => {
    const cleanedText = inputText.replace(/\r?\n|\r/g, '');
          ...
          <Card variant="elevated">
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
              <div style={{ 
                ...
                <Scissors size={20} style={{ color: '#ffffff' }} />
              </div>
            ...
            <div style={{ marginBottom: '24px' }}>
              ...
              <textarea
                ...
                placeholder="여기에 줄바꿈을 제거할 텍스트를 입력하세요..."
                value={inputText}
            ...
            <Button 
              ...
              style={{ width: '100%' }}
            >
              <Scissors size={20} style={{ marginRight: '8px' }} />
              줄바꿈 제거하기
            </Button>
          </Card>
            ...
            <div style={{ marginBottom: '24px' }}>
              ...
              <div style={{ position: 'relative' }}>
                <textarea
                  ...
                  placeholder="줄바꿈이 제거된 텍스트가 여기에 표시됩니다."
                  value={outputText}
                />
                {outputText && (
                  <button
        ...
        <div style={{ 
          ...
          <div style={{ textAlign: 'center', marginBottom: '40px' }}>
            ...
            <p style={{ fontSize: '16px', color: '#6b7280', maxWidth: '600px', margin: '0 auto' }}>
              줄바꿈 제거 도구는 다양한 상황에서 유용하게 사용됩니다
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ textAlign: 'center' }}>
              <div style={{ 
                ...
                <Scissors size={24} style={{ color: '#ffffff' }} />
              </div>
              <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#1f2937', marginBottom: '8px' }}>
                문서 정리
              </h3>
              <p style={{ fontSize: '14px', color: '#6b7280', lineHeight: '1.5' }}>
                복사한 텍스트의 불필요한 줄바꿈을 제거하여 깔끔하게 정리
              </p>
            </div>
