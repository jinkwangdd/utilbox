...
import { ClipboardCopy, ClipboardCheck, Filter } from 'lucide-react';
...
export default function RemoveSpecialCharactersPage() {
  ...
  const handleRemoveSpecialCharacters = () => {
    // 특수문자 제거 정규식: 알파벳, 한글, 숫자, 공백을 제외한 모든 문자
    const cleanedText = inputText.replace(/[^a-zA-Z0-9가-힣\s]/g, '');
          ...
          <Card variant="elevated">
            ...
            <div style={{ marginBottom: '24px' }}>
              ...
              <textarea
                ...
                placeholder="여기에 특수문자를 제거할 텍스트를 입력하세요..."
                value={inputText}
            ...
            <div style={{ marginBottom: '24px' }}>
              ...
              <div style={{ position: 'relative' }}>
                <textarea
                  ...
                  placeholder="특수문자가 제거된 텍스트가 여기에 표시됩니다."
                  value={outputText}
                />
                {outputText && (
                  <button
        ...
        <div style={{ 
          ...
          <div style={{ textAlign: 'center', marginBottom: '40px' }}>
            ...
            <p style={{ fontSize: '16px', color: '#6b7280', maxWidth: '600px', margin: '0 auto' }}>
              다음 특수문자들이 모두 제거되어 깔끔한 텍스트를 만듭니다
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ textAlign: 'center' }}>
              <div style={{ 
                ...
                <Filter size={24} style={{ color: '#ffffff' }} />
              </div>
              <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#1f2937', marginBottom: '8px' }}>
                문장부호
              </h3>
              <p style={{ fontSize: '14px', color: '#6b7280', lineHeight: '1.5' }}>
                마침표, 쉼표, 느낌표, 물음표, 따옴표 등
              </p>
            </div>
